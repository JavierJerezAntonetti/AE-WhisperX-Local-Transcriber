...
(function createAndRunWhisperPanel(thisObj) {
  ...
  var buildUI = function (uiTargetObj) {
    ...
    geminiApiKeyInput.helpTip =
      "Optional: Enter your Gemini API key to use Gemini 3.6 Flash for intelligent sentence splitting (max 9 words per sentence). Only used when Transcription Level is set to 'Sentence Level'. Leave empty to use original segments.";
